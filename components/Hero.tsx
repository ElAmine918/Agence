      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 sm:px-10 flex flex-col h-full justify-between flex-grow">
        ...
        <div className="flex-grow flex flex-col justify-center relative">
          ...
          <div className="flex flex-col gap-12 relative">
            <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-br from-[#D8B4FE]/5 to-[#CFFAFE]/5 blur-[120px] rounded-full pointer-events-none -z-10" />
            <BlurReveal delay={0.1}>
              <h1 className="text-[80px] sm:text-[100px] lg:text-[140px] font-sans font-normal text-white tracking-tighter-xl leading-[0.92] max-w-4xl m-0 p-0">
                Digital, <br />
                <span className="font-serif italic font-light bg-gradient-to-r from-[#D8B4FE] via-[#E9D5FF] to-[#FBCFE8] text-transparent bg-clip-text tracking-tighter-lg">Élégant</span> <br />
