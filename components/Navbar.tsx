        ...
        >
          ...
          <div className="flex items-center gap-3 z-50">
            <MagneticButton strength={15}>
              <Link
                href="#contact"
                className="hidden md:flex items-center gap-2 bg-gradient-to-r from-[#D8B4FE] via-[#E9D5FF] to-[#FBCFE8] text-black px-5 py-2 rounded-full text-sm font-semibold hover:opacity-90 transition-opacity group shadow-[0_0_20px_rgba(216,180,254,0.3)]"
              >
                Contact
